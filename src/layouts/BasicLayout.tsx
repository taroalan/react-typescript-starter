    ...
    return (
      <Layout className="basic-layout">
        ...
        >
          ...
          <Menu className="basic-layout-sidermenu" theme="dark" mode="inline" defaultSelectedKeys={['1']}>
            <SubMenu
              key="dashboard"
              title={<span><Icon type="dashboard" /><span>Dashboard</span></span>}>
              <MenuItem key="analyais">分析页</MenuItem>
              <MenuItem key="monitor">监控页</MenuItem>
              <MenuItem key="workbench">工作台</MenuItem>
            </SubMenu>
            <MenuItem key="1">
              <Icon type="user" />
              <span>Menu One</span>
        ...
        <Layout>
          ...
          <Content style={{ margin: '24px 16px', padding: '24px', backgroundColor: '#fff', minHeight: "280px" }}>
            {this.props.children}
          </Content>
        </Layout>
      </Layout>
